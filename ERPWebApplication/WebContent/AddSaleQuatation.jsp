...
function getSize(id){
		  var xmlhttp;
			  ...
			  xmlhttp.send();
               ...
               <form name="Quatation_form" action="SalesStuff" method="post"  >
                        <div class="span12">   
...
<div style="margin-left: 65%;">
		...
		<input type="radio" name="status" value="Sales Order"/>Sales Order
								...
								<td></td>
									...
									<td>
										<select id="s2_1" style="width: 100%" class="form-control" name="supplier">
											...
											GenericsDao<customer_model> sg=new GenericsImp<customer_model>();
											List<customer_model> ls=sg.viewData(ss);
											for(int i=0;i<ls.size();i++)
											{
											%>
			             					<option value=<%=ls.get(i).getCustomerid() %>><%=ls.get(i).getCustomername()%></option>
			             					<%} %>
                      ...
                      <div class="contents boxpadding" >
                            ...
                            <form action="PurchaseStuff" name="q_detail" method="post">
                              ...
                              <div class="tab-pane" id="profile">
                               		...
                               		<table style="margin-left: 25px;" cellpadding="10" cellspacing="10" class="table table-condensed">
							
									<tr>
									<td>
										<table style="border-spacing: 100px 100px;" cellpadding="10" cellspacing="10" class="table table-condensed">
										
									<tr>
									<td>Responsible</td>
                            	<td style="border-left: 1px solid #cdcdcd;">
                            	<select name="responsible" style="width:70%" class="form-control">
								...
								<tr>
									<td>Payment Term</td>
									<td style="border-left: 1px solid #cdcdcd;">  <select id="oe-field-input-86" style="width: 70%" class="form-control" name="payment_method">
									...
									<td>
										<table  cellpadding="15" cellspacing="15" class="table table-condensed" style="border-spacing: 100px 100px;">
											<tr>
												...
												<td style="border-left: 1px solid #cdcdcd;">  <select id="oe-field-input-86" style="width:70%" class="form-control"  name="shippingmethod">
            
                
            
                <option value="Delivar Each Product when available">
                    Delivar Each Product when available
                </option>
            
                <option value="Delivar All Products at Once">
                   Delivar All Products at Once
                </option>
											...
											<td>Create Invoice</td><td style="border-left: 1px solid #cdcdcd;">
												 <select id="oe-field-input-86" class="form-control" style="width: 70%" name="createinvoice">
            
                <option value="On Demand">
                    On Demand
                </option>
            
                <option value="On Delivary Order">
                  On Delivary Order
                </option>
                 <option value="Before Delivary">
                 Before Delivary
                </option>
