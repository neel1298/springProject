...
function validation(){
	...
	var c_name=document.f1.category;
	if(c_name.value==""){
		alert("Enter the Category");
		c_name.focus();
		return false;
	}
	var p_name=document.f1.parent.selectedIndex;
	if(p_name==0){
		alert("Select the Parent Category");
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
												  ...
												  <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="Category" class="form-control" name="category"> </td>
                                                </tr>
                                               <tr>
                                                    <td class="col-md-4">Parent Category</td>
                                                    <td class="col-md-8">
