...
font-size: 20px;
                  ...
                  <div class="block">                  
<form name="supplier_form" method="post" action="CustomerActionController"
	 autocomplete='off' >
						 ...
						 <td><input type="button" class="form-control various fsv-update" href="AddCity.jsp" value="+" style="width:34px;height:32px;" data-fancybox-type="iframe"/></td>
								...
								<tr>
									<td>
										...
										<table id="tbl4" cellspacing="3" cellpadding="5" border="0" style="border-spacing: 100px 100px;" class="table table-condensed">
                           	...
                           	<td colspan="3"><textarea rows="7"  class="form-control" cols="20" name="description" style="width:95%;" placeholder="Internal Note"></textarea><td><input type="hidden" value="CompanySave" name="hid" /></td></td>
                           	</tr>
							</table>
		     	</div>
		     	</div>
