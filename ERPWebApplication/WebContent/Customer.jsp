							...
							<div class="table-box">
								...
								<tr>
									<td>
										<table id="tbl2" class="table table-condensed" style="border-spacing: 20px 20px;" cellpadding="5" cellspacing="5">
											 ...
											 <tr>
                            					...
                            					<td>Name</td>
                            					<td><input type="text" class="form-control" name="customer" /></td><td></td>
                            				</tr>
									...
									<tr id="company" style="display:none;">
												...
												<%
												company_model cc=new company_model();
												GenericsDao<company_model> gg=new GenericsImp<company_model>();
												
												List<company_model> ll=gg.viewData(cc);
												
												
												%>
												<%	for(company_model u:ll)
{
%>
						 ...
						 <td><input type="button" class="form-control various fsv-update"  style="width:34px;height:32px;" href="AddCity.jsp" value="+" data-fancybox-type="iframe"/></td>
								...
								<tr>
                          			...
                          			<td>
										...
										Generics<Title_model> genn=new GenericsDaoImp<Title_model>();
                              ...
                              <tr>
                            	<td><input type="hidden" name="hid" value="customerSave"></td>
                            	<td>
                            	</td><td></td>
                            </tr>
										</table>
