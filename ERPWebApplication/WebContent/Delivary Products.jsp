...
List<delivaryproducts_model> l=new ArrayList<delivaryproducts_model>();
List<SalesOrder_model> l2=new ArrayList<SalesOrder_model>();
l=p.viewDelivaryProductByid(id11);
                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        ...
                                        <table class="table table-condensed" id="example">
                                            ...
                                            <tbody>
                                            	<% int k=1;
for(delivaryproducts_model pp:l)
{
%>											<%
													List<customer_model> sa=p.viewcustomerycid(l2.get(0).getCustomer());
%>
                                                <tr onclick="clickrow(<%=pp.getDelivaryorder_id()%>);"  style="cursor: pointer" class="gradeX">
                                             
                                                    <td><%=pp.getSchedule_dt() %></td>
                                                   <td><%=l2.get(0).getPrefix()%><%=pp.getDelivaryorder_id() %>
                                         			</td>
                                         			<td><%=sa.get(0).getCustomername() %></td>
                                                    <td class="center"><%=pp.getQuantity() %></td>
