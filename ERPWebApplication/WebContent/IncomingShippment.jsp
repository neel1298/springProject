...
function f1()
{
	...
	ff.action="NewHome.jsp?p=AddIncomingShippment";
...
List<IncomingShippment_model> l=new ArrayList<IncomingShippment_model>();
List<PurchaseOrder_model> l2=new ArrayList<PurchaseOrder_model>();
	l=p.viewIncomingShippmentByid(id11);
                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        ...
                                        <table class="table table-condensed" id="example">
                                            ...
                                            <tbody>
                                            	<% int k=1;
for(IncomingShippment_model pp:l)
{
%>											<%
													request.getSession().setAttribute("status", "not");
													ArrayList<Supplier_model> sa=p.viewSupplierInfo(pp.getSupplier()); %>

                                          <tr onclick="clickrow(<%=pp.getIncomingshippment_id() %>);"  style="cursor: pointer" class="gradeX">
                                          
                                             
                                                    <td><%=pp.getPrefix()%><%=pp.getIncomingshippment_id()%></td>
                                                   <td><%=sa.get(0).getSuppliername() %>
                                         			</td>
                                         			<td><%=l2.get(0).getPrefix()%><%=pp.getPurchaseorder_id() %></td>
                                                    <td class="center"></td>
