...
function f1()
{
	...
	ff.action="NewHome.jsp?p=AddProducts";
...
{
	window.document.location="UserController?action=ViewProduct&id="+id;
}
...
List<Product_model> l=new ArrayList<Product_model>();
	l=p.viewProductByid(id11);
                                ...
                                <div class="contents">
                                    ...
                                    <div class="table-box">
                                        ...
                                        <table class="table table-condensed" id="example">
                                            ...
                                            <tbody>
                                            	<% int k=1;
for(Product_model pp:l)
{
%>											
                                                <tr onclick="clickrow(<%=pp.getProductid()%>);"  style="cursor: pointer" class="gradeX">
                                             
                                                    <td>opop</td>
                                                    <td><%=pp.getProductCategory() %></td>
                                         			<td><%=pp.getProduct()%></td>
                                                    <td class="center"><%=pp.getDescription()%></td>
                                                    <td class="center">	 <input type="submit" class="btn btn-success text-center" style="width: 30px; height: 30px" value="E"  onclick="editProduct(<%=pp.getProductid()%>);">
           	  <input type="submit" class="btn btn-danger text-center" style="width: 30px; height: 30px" value="D" onClick="deletedata(<%=pp.getProductid()%>);" name="hid"></td>
           </td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th><input type="text" name="search_engine" value="Search ProductType" class="search_init" /></th>
                                                    <th><input type="text" name="search_browser" value="Search ProductCategory " class="search_init" /></th>
                                                    <th><input type="text" name="search_platform" value="Search Product" class="search_init" /></th>
