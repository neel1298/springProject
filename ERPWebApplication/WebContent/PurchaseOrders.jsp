...
{
	window.document.location="UserController?action=ViewPurchaseOrder&id="+id;
}
...
List<PurchaseOrder_model> l=new ArrayList<PurchaseOrder_model>();
	l=p.viewPurchseOrderByid(id11);
