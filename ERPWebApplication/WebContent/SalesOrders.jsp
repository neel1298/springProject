...
{
	window.document.location="UserController?action=ViewSalesOrder&id="+id;
}
...
List<SalesOrder_model> l=new ArrayList<SalesOrder_model>();
	l=p.viewSalesOrderByid(id11);
