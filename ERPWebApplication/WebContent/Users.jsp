...
%>											
           	 ...
           	 <input type="submit" class="btn btn-success text-center" style="width: 50px; height: 30px" value="Edit"  onclick="editUser(<%=u.getUserid()%>);">
           	  <input type="submit" class="btn btn-danger text-center" style="width: 57px; height: 30px" value="Delete" onClick="deletedata(<%=u.getUserid()%>);" name="btnclick" > <input type="submit" class="btn btn-inverse text-center" style="width: 50px; height: 30px" value="More" onClick="viewdata('<%=u.getUserid()%>')" name="btnclick" > 
