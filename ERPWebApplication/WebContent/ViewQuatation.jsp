...
function EditQ(edit_id) {
	window.location.assign("NewHome.jsp?p=EditQuatations&id="+edit_id+"");
}
function getItem(id){
	  var xmlhttp;
	...
	a2.submit();
             	...
             	<% 
						//	HttpSession ses=request.getSession();
							...
							List<Quatation_model> quatation=pp.viewQuatationInfo(qqid);
...
<header>
	...
	<input type="button" class="form-control btn btn-primary text-center" style="width: 56px; height: 30px" onClick="exit()" value="Cancel" />
	    <form name="company_form" action="EditQuatation" method="post" >
							...
							<tr>
								<td></td>
									...
									<td>
										...
										<input type="hidden" value=<%=quatation.get(0).getQuotation_id() %> name="qid">
									<tr>
									<td>
										Supplier
									</td>
                      ...
                      <div class="contents boxpadding">
                            ...
                            <form action="PurchaseStuff" name="q_detail" method="post">
                              ...
                              <div class="tab-pane" id="profile">
                                           		...
                                           		<table style="margin-left: 25px;" class="table table-condensed" cellpadding="10" cellspacing="10">
								...
								<tr>
									<td>Expected Date</td>
									<td style="border-left: 1px solid #cdcdcd;"><%=quatation.get(0).getExpected_dt() %></td>
								</tr>
									...
									<td>
										<table  cellpadding="15" cellspacing="15" class="table table-condensed" style="border-spacing: 100px 100px;">
											<tr>
												<td>Payment Term</td>
												<td style="border-left: 1px solid #cdcdcd;"><%=quatation.get(0).getPaymentterm()%>
												</td>
											</tr>
