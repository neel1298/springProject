...
function checkavailability(sid)
{
var a2=document.check_form;
	a2.action="NewHome.jsp?p=CheckAvailability&saleid="+sid;
	a2.submit();
}
               ...
               <form name="check_form" action="PurchaseOrderController" method="post" >
               <% 
							...
							List<SalesOrder_model> quatation=pp.viewSalesOrderInfo(qqid);
                        ...
                        <h1>&nbsp;&nbsp;&nbsp;Sales Or.../<%=quatation.get(0).getPrefix() %><%=qqid%></h1>
                        </div>
                        <div class="block">                  
<header>
...
<input type="submit" class="btn btn-inverse text-center" value="Send by Email"  name="btnclick" >
 ...
 <input type="button" class="btn btn-danger" value="View Delivary Order" name="btnClick" onClick="checkavailability(<%=quatation.get(0).getSalesorder_id()%>)" style="margin-left: 7px;">
 <input type="submit" class="btn btn-danger" value="Create Invoice" name="btnClick"  style="margin-left: 7px;">
 <input type="button" class="btn btn-inverse text-center" value="Cancel Order" style="margin-left: 7px;"  name="btnclick">
...
<div style="margin-left: 55%;">
		...
		<input type="radio" name="status" value="Sales Order"  <%if(quatation.get(0).getStatus().equalsIgnoreCase("Sales Order")){ %> checked="checked" <%}else{ %> disabled="disabled" <%}  %> />Sales Order
			<input type="radio" name="status" value="Sale to Invoice"  <%if(quatation.get(0).getStatus().equalsIgnoreCase("Sale to Invoice")){ %> checked="checked" <%}else{ %> disabled="disabled" <%}  %> />Sale to Invoice
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="sec-box">
						 	...
						 	<span style="font-size: 20px;"><b>&nbsp;&nbsp;&nbsp;Sales Order/<%=quatation.get(0).getPrefix() %><%=qqid%></b></span>
						 	</br></br>
							...
							<tr>
								<td></td>
									...
									<td>
										...
										<input type="hidden" name="poid" value=<%=quatation.get(0).getSalesorder_id() %>>
									<tr>
									<td>
										Customer
									</td>
									<td>
										...
										List<customer_model> ls=a.viewCustomerBycustid(sid);
										%>
                      ...
                      <div class="contents boxpadding">
                                <ul class="nav nav-pills" id="myTab">
                                    <li class="active"><a href="#home" data-toggle="tab">Order Lines</a></li>
                            ...
                            <form action="PurchaseStuff" name="q_detail" method="post">
                              ...
                              <div class="tab-pane" id="profile">
								...
								<tr>
									...
									<td>
										<table  cellpadding="15"  class="table table-condensed" cellspacing="15" style="border-spacing: 100px 100px;">
											<tr>
